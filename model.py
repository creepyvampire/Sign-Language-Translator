...
X, Y = np.array(landmarks), tf.keras.utils.to_categorical(labels).astype(int)
...
model.add(tf.keras.layers.LSTM(32, return_sequences=True, activation='relu', input_shape=(10,126)))
